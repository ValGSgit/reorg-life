  ...
  return (
    ...
    >
      <View>
        <H>Welcome</H>
        <Sub>
          Choose a companion. It grows as you look after the parts of your life that matter to you. Everything
          stays on this phone.
        </Sub>
      </View>
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12, justifyContent: 'center' }}>
        {CHARACTERS.map((x) => (
          <Pressable
            ...
            accessibilityLabel={`Choose ${x.name}`}
            onPress={() => setSel(x.id)}
            style={{
              borderWidth: 2,
              borderColor: sel === x.id ? t.accent : t.line,
              borderRadius: 18,
              padding: 6,
